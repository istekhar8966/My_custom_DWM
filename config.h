...
static unsigned int snap            = 21;       /* snap pixel */
...
static char dmenufont[]             = "JetBrainsMono Nerd Font Mono:size=10";
static const char *fonts[]          = {  "JetBrainsMono Nerd Font Mono:size=10", "NotoColorEmoji:pixelsize=16:antialias=true:autohint=true"};
...
#define CHROME "google-chrome-stable"

/* commands */
static char dmenumon[2] = "0"; /* component of dmenucmd, manipulated in spawn() */
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *chatgptcmd[] = { "chromium", "--app=https://chatgpt.com", NULL };

static const char *nautiluscmd[] = {
    "sh", "-c",
    "env DISPLAY=:0 DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/$(id -u)/bus nautilus",
    NULL
};
...
static const Key keys[] = {
    ...
    STACKKEYS(MODKEY,                          focus)
        ...
        TAGKEYS(                        XK_1,                      0)
            ...
            { MODKEY,		    	XK_e,          spawn,      {.v = (const char*[]){ CHROME, NULL } } },

            //{ MODKEY,		    	XK_f,          spawn,      {.v = (const char*[]){ "st", "-e", "fff", NULL } } },
            { MODKEY,		    	XK_n,          spawn,      {.v = (const char*[]){ "st", "-e", "vim", NULL } } },
            ...
            { MODKEY,				XK_F6,     spawn,       SHCMD("pactl set-sink-volume 0 +10%") },
            { MODKEY,				XK_F5,     spawn,       SHCMD("pactl set-sink-volume 0 -10%") },
};
